Config = {
    ...
    logs = {
        shop = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
        recolte = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
        CoffreObjets = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
        Preparation = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
        Mission = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
        Annonce = "https://canary.discord.com/api/webhooks/986677092278214706/_Axd9M4MmbV2mvdePc-Tpg7TcEK9rb4ccUidyP9HVWvzNyJYumjXW3fdw-aZuVS3duPK",
    },
    ...
    deliveryItems = {
        ...
        {label = "Poulet", name = "poulet", prix = 5},
    ...
    allMeal = {
        {label = "Cheese Junior", name = "cheesejuniormenu", ingredients = { {label = "Steak de boeuf", name = "steakboeuf", amout = 1}, {label = "Cornichons", name = "cornichons", amout = 1}, {label = "Cheddar", name = "cheddar", amout = 1}, {label = "Sauce originale", name = "originalesauce", amout = 1} }},
        {label = "Double Cheese", name = "doublecheesemenu", ingredients = { {label = "Steak de boeuf", name = "steakboeuf", amout = 2}, {label = "Cornichons", name = "cornichons", amout = 1}, {label = "Cheddar", name = "cheddar", amout = 1}, {label = "Sauce originale", name = "originalesauce", amout = 1} }},
        {label = "Panini Steak", name = "paninisteakmenu", ingredients = { {label = "Steak de boeuf", name = "steakboeuf", amout = 1}, {label = "Cornichons", name = "cornichons", amout = 1}, {label = "Cheddar", name = "cheddar", amout = 1}, {label = "Sauce BBQ", name = "bbqsauce", amout = 1} }},
        {label = "Panini Fromage", name = "paninifromagemenu", ingredients = { {label = "Cheddar", name = "cheddar", amout = 1}, {label = "Sauce originale", name = "originalesauce", amout = 1} }},
    },
    ...
    allFrite = {
        ...
        {label = "Tenders", name = "chicken", ingredients = {{label ="Poulet", name ="poulet", amout =3},{label ="Pincée de sel", name ="salar", amout =1}}},
    },
    ...
    ListVeh = {
		{nom = "Véhicule Ambuscade", model = "taco"},
	},
